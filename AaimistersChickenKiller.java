...
public class AaimistersChickenKiller extends Script implements MessageListener,
	...
	public class AaimistersGUI {
		...
		private void initComponents() {
			...
			final JLabel lblStopAt = new JLabel("Stop at Level:");
			...
			gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_1.createSequentialGroup().addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_1.createSequentialGroup().addGap(28).addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_1.createSequentialGroup().addComponent(arrowBox, GroupLayout.PREFERRED_SIZE, 107, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(featherBox, GroupLayout.PREFERRED_SIZE, 107, GroupLayout.PREFERRED_SIZE)).addGroup(gl_panel_1.createSequentialGroup().addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addComponent(lblPaintColor, GroupLayout.PREFERRED_SIZE, 79, GroupLayout.PREFERRED_SIZE).addComponent(lblLocation, GroupLayout.PREFERRED_SIZE, 79, GroupLayout.PREFERRED_SIZE).addComponent(lblStatUsing, GroupLayout.PREFERRED_SIZE, 79, GroupLayout.PREFERRED_SIZE).addComponent(lblStopAt, GroupLayout.PREFERRED_SIZE, 99, GroupLayout.PREFERRED_SIZE)).addGap(10).addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addComponent(levelBox, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE).addComponent(statBox, GroupLayout.PREFERRED_SIZE, 102, GroupLayout.PREFERRED_SIZE).addComponent(colorBox, GroupLayout.PREFERRED_SIZE, 102, GroupLayout.PREFERRED_SIZE).addComponent(locationBox, GroupLayout.PREFERRED_SIZE, 102, GroupLayout.PREFERRED_SIZE))).addGroup(gl_panel_1.createSequentialGroup().addComponent(waitBox, GroupLayout.PREFERRED_SIZE, 107, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(buryBox, GroupLayout.PREFERRED_SIZE, 107, GroupLayout.PREFERRED_SIZE)).addComponent(antibanBox, GroupLayout.PREFERRED_SIZE, 107, GroupLayout.PREFERRED_SIZE))).addGroup(gl_panel_1.createSequentialGroup().addGap(61).addComponent(paintBox))).addContainerGap(39, Short.MAX_VALUE)));
			gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_1.createSequentialGroup().addGap(24).addComponent(paintBox).addGap(18).addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(waitBox).addComponent(buryBox)).addGap(18).addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(arrowBox).addComponent(featherBox)).addGap(18).addComponent(antibanBox).addGap(18).addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(lblStatUsing, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE).addComponent(statBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)).addGap(18).addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(lblLocation, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE).addComponent(locationBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)).addGap(18).addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(lblPaintColor).addComponent(colorBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)).addGap(18).addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(lblStopAt, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE).addComponent(levelBox, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)).addContainerGap()));
			...
			final JLabel lblNewLabel = new JLabel("visit the thread at:");
			lblNewLabel.setFont(new Font("Cambria Math", Font.BOLD, 11));

			final JTextPane txtpnHttpwwwpowerbotorgvbshowthreadphpt = new JTextPane();
			...
			gl_panel_4.setHorizontalGroup(gl_panel_4.createParallelGroup(Alignment.TRAILING).addGroup(gl_panel_4.createSequentialGroup().addContainerGap().addComponent(breakBox).addGap(18).addComponent(randomBox, GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE).addContainerGap()).addGroup(gl_panel_4.createSequentialGroup().addContainerGap().addComponent(lblTimeBetweenBreaks, GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE).addGap(121)).addGroup(Alignment.LEADING, gl_panel_4.createSequentialGroup().addContainerGap().addComponent(lblBreakLengths, GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE).addGap(167)).addGroup(gl_panel_4.createSequentialGroup().addGroup(gl_panel_4.createParallelGroup(Alignment.TRAILING).addGroup(gl_panel_4.createSequentialGroup().addContainerGap(28, Short.MAX_VALUE).addComponent(minTimeBeBox, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(lblMins, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE).addGap(30).addComponent(lblTo)).addGroup(Alignment.LEADING, gl_panel_4.createSequentialGroup().addGap(27).addComponent(minBreakBox, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(label_4, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED, 31, Short.MAX_VALUE).addComponent(label_5))).addGap(34).addGroup(gl_panel_4.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_4.createSequentialGroup().addComponent(maxTimeBeBox, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(label_3, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)).addGroup(gl_panel_4.createSequentialGroup().addComponent(maxBreakBox, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(label_6, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE))).addGap(36)).addGroup(Alignment.LEADING, gl_panel_4.createSequentialGroup().addGap(85).addComponent(lblNewLabel).addContainerGap(131, Short.MAX_VALUE)).addGroup(Alignment.LEADING, gl_panel_4.createSequentialGroup().addContainerGap().addComponent(txtpnHttpwwwpowerbotorgvbshowthreadphpt, GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE).addContainerGap()));
			gl_panel_4.setVerticalGroup(gl_panel_4.createParallelGroup(Alignment.TRAILING).addGroup(Alignment.LEADING, gl_panel_4.createSequentialGroup().addGap(36).addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE).addComponent(randomBox).addComponent(breakBox)).addGap(36).addComponent(lblTimeBetweenBreaks).addGap(18).addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE).addComponent(minTimeBeBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent(label_3, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE).addComponent(maxTimeBeBox, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE).addComponent(lblTo).addComponent(lblMins, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)).addGap(37).addComponent(lblBreakLengths).addGap(18).addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE).addComponent(minBreakBox, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE).addComponent(label_4, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE).addComponent(label_5, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE).addComponent(maxBreakBox, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE).addComponent(label_6, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)).addGap(18).addComponent(lblNewLabel).addPreferredGap(ComponentPlacement.UNRELATED).addComponent(txtpnHttpwwwpowerbotorgvbshowthreadphpt, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addContainerGap(13, Short.MAX_VALUE)));
		...
		private void submitActionPerformed(final ActionEvent e) {
			...
			final String chosen = locationBox.getSelectedItem().toString();
			...
			final String stats = statBox.getSelectedItem().toString();
			...
			try {
				...
				out.write((buryBox.isSelected() ? true : false) + ":" // 0
						+ locationBox.getSelectedIndex() + ":" // 1
						+ statBox.getSelectedIndex() + ":" // 2
						+ colorBox.getSelectedIndex() + ":" // 3
						+ (antibanBox.isSelected() ? true : false) + ":" // 4
						+ (waitBox.isSelected() ? true : false) + ":" // 5
						+ (featherBox.isSelected() ? true : false) + ":" // 6
						+ (arrowBox.isSelected() ? true : false) + ":" // 7
						+ (paintBox.isSelected() ? true : false) + ":" // 8
						+ (breakBox.isSelected() ? true : false) + ":" // 9
						+ (randomBox.isSelected() ? true : false) + ":" // 10
						+ maxTimeBeBox.getText() + ":" // 11
						+ minTimeBeBox.getText() + ":" // 12
						+ maxBreakBox.getText() + ":" // 13
	...
	private RSArea Pen;
	private final RSArea ChickenPenF = new RSArea(new RSTile(3014, 3282), new RSTile(3020, 3297));
	private final RSArea ChickenPenLum = new RSArea(new RSTile(3225, 3295), new RSTile(3236, 3301));

	private final RSArea ChickenPenFout = new RSArea(new RSTile(3026, 3282), new RSTile(3037, 3291));
	...
	private long now;
	private final ArrayList<Integer> loot = new ArrayList<Integer>();
	...
	private final Image logo = getImage("http://i88.photobucket.com/albums/k170/aaimister/AaimistersChickenKiller.gif");
	...
	private RSGroundItem arrow() {
		return groundItems.getNearest(new Filter<RSGroundItem>() {
			public boolean accept(final RSGroundItem g) {
				return g.getItem().getID() == arrow
						&& Pen.contains(g.getLocation());
			}
		});
	}
	...
	public void bury(final boolean leftToRight, final int... items) {
	...
	public void buryItem(final int col, final int row) {
		...
		if (game.getCurrentTab() != 4 && !interfaces.get(762).isValid()
	...
	public boolean checkLog() {
		if (getMyPlayer().isOnScreen() && game.isLoggedIn()
				&& calc.distanceTo(InPen) < 20) {
			return true;
		} else {
			return false;
		}
	...
	public boolean dyingChic() {
		for (final RSNPC i : npcs.getAll()) {
			if (i.getAnimation() == 5389
					&& calc.distanceTo(i.getLocation()) < 2
	...
	private RSGroundItem feather() {
		return groundItems.getNearest(new Filter<RSGroundItem>() {
			public boolean accept(final RSGroundItem g) {
				return g.getItem().getID() == feathers
						&& Pen.contains(g.getLocation());
			}
		});
	}
	...
	public int loop() {
		...
		if (skills.getCurrentLevel(stat) >= stopLevel) {
			log.severe("You have reached level " + stopLevel
					+ "! Stopping Script...");
			game.logout(false);
			stopScript();
		}
		...
		case ATTACK:
			if (atPen()) {
				...
				if (players.getMyPlayer().getInteracting() != null) {
					...
					if (loot.contains(feathers) || loot.contains(bones)
							|| loot.contains(arrow)) {
						wait = true;
						skip = false;
					}
				...
				try {
					...
					if (chic != null && !wait) {
						...
						if (chic.isOnScreen()) {
							...
							final RSTile chicT = walking.getClosestTileOnMap(chic.getLocation()).randomize(-1, 1);
						...
						if (inventory.containsOneOf(drop)) {
							...
							final RSItem d = inventory.getItem(drop);
							d.doAction("Drop");
							return random(350, 600);
						} else if (inventory.isFull()) {
							while (inventory.contains(bones)) {
								status = "Burying bones...";
								bury(true, 995, arrow, feathers);
								sleep(600, 1350);
							}
						} else {
							if (Pen.contains(getMyPlayer().getLocation())
								...
								skip = true;
								while (feather() != null
										&& loot.contains(feathers)
										&& checkLog()) {
									status = "Looting feathers...";
									if (feather().isOnScreen()) {
										feather().doAction("Take "
												+ feather().getItem().getName());
										sleep(800, 1200);
										totalFeather = inventory.getCount(true, 314)
												- checkFea;
										return 1;
									} else {
								...
								while (arrow() != null && loot.contains(arrow)
										&& checkLog()) {
									status = "Picking up arrows...";
									if (arrow().isOnScreen()) {
										arrow().doAction("Take "
												+ arrow().getItem().getName());
								...
								while (bones() != null && loot.contains(bones)
										&& checkLog()) {
		...
		case BACKTOCHICK:
			...
			if (!atPen()) {
				...
				if (idle() && !getMyPlayer().isInCombat()) {
					final RSTile Next = walking.getClosestTileOnMap(InPen).randomize(-2, 2);
	...
	public void onFinish() {
		...
		if (loot.contains(bones)) {
			log("In " + formattedTime + " You killed "
					+ formatter.format(totalChic) + " chickens, gained "
					+ formatter.format(sgainedLvl) + " Level(s), and buried "
					+ formatter.format(buriedBones) + " bones!");
		} else {
			log("In " + formattedTime + " You killed "
					+ formatter.format(totalChic) + " chickens, and gained "
					+ formatter.format(sgainedLvl) + " Level(s)!");
		}
	}
	...
	public void onRepaint(final Graphics g) {
		...
		if (!xButton) {
			...
			if (Main) {
				...
				// Column 2
				g.drawString(currentStat + " Total XP: "
						+ formatter.format((long) sxpGained), 264, 390);
				g.drawString(currentStat + " XP/h: "
						+ formatter.format((long) sxpHour), 264, 404);
				g.drawString(currentStat + " XP to Lvl: "
						+ formatter.format((long) scurrentXP), 264, 418);
			...
			if (StatC) {
				...
				g.drawString("Total XP/h: " + formatter.format((long) xpHour), 63, 463);
				// Column 2
				g.drawString("Cons. Total XP: "
						+ formatter.format((long) cxpGained), 264, 390);
				g.drawString("Cons. XP/h: " + formatter.format((long) cxpHour), 264, 404);
				g.drawString("Cons. XP to Lvl: "
						+ formatter.format((long) ccurrentXP), 264, 418);
			...
			if (StatP) {
				...
				g.drawString("Total XP/h: " + formatter.format((long) xpHour), 63, 463);
				// Column 2
				g.drawString("Prayer Total XP: "
						+ formatter.format((long) pxpGained), 264, 390);
				g.drawString("Prayer XP/h: " + formatter.format((long) pxpHour), 264, 404);
				g.drawString("Prayer XP to Lvl: "
						+ formatter.format((long) pcurrentXP), 264, 418);
			...
			if (StatM) {
				...
				g.drawString("Total Money: $"
						+ formatter.format((long) totalGP), 264, 390);
				g.drawString("Money / Hour: $"
						+ formatter.format((long) gpHour), 264, 404);
				g.drawString("Price of Feathers: $"
						+ formatter.format((long) priceFeather), 264, 418);
				g.drawString("Total Feather(s): "
						+ formatter.format((long) totalFeather), 264, 433);
				g.drawString("Feather(s) / Hour: "
						+ formatter.format((long) featherHour), 264, 447);
			...
			if (StatI) {
				...
				g.drawString("Total XP/h: " + formatter.format((long) xpHour), 63, 463);
				// Column 2
				g.drawString("Chic(s) Killed: "
						+ formatter.format((long) totalChic), 264, 390);
				g.drawString("Chic(s) / Hour: "
						+ formatter.format((long) chicHour), 264, 404);
				g.drawString("Chic Killing: " + currentChic, 264, 418);
				g.drawString("Chic(s) to Lvl: "
						+ formatter.format((long) chicToLvl), 264, 433);
			...
			g.fillRect(6, 320, skills.getPercentToNextLevel(barStat)
					* (508 / 100), 16);
			g.setColor(White);
			g.setFont(Cam);
			g.drawString("" + skills.getPercentToNextLevel(barStat)
					+ "% to lvl " + (skills.getCurrentLevel(barStat) + 1) + " "
					+ currentStat, 194, 332);
			// Shadow
			g.setColor(White90);
	...
	public void randomTile() {
		final RSTile random = InPen.randomize(-5, 5);
	...
	public void rotateCamera() {
		...
		final char[] DU = new char[] { KeyEvent.VK_DOWN, KeyEvent.VK_UP };
