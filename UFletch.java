...
@ScriptManifest(authors = { "Fletch To 99" }, keywords = "Fletching", name = "UFletch", website = "http://www.universalscripts.org/ufletch", version = 2.28, description = "The best fletcher!", requiresVersion = 244)
/**
...
public class UFletch extends Script implements PaintListener, MouseListener,
	...
	private long startTime = System.currentTimeMillis(), ct = System
			.currentTimeMillis();
		...
		try {
			...
			if (code == 200) {
				icon = getImage("fav.png", true,
						"http://www.universalscripts.org/Images/fav.png");
				fletchIcon = getImage("fletchIcon.png", true,
						"http://www.universalscripts.org/Images/fletchIcon.png");

				settings = getImage("settings.png", true,
						"http://www.universalscripts.org/Images/settings.png");
				bow = getImage("bow.png", true,
						"http://www.universalscripts.org/Images/bow.png");
				logsImage = getImage("logs.png", true,
						"http://www.universalscripts.org/Images/logs.png");
				axe = getImage("axe.png", true,
						"http://www.universalscripts.org/Images/axe.png");
				knife = getImage("knife.png", true,
						"http://www.universalscripts.org/Images/knife.png");
				brush = getImage("paint.png", true,
						"http://www.universalscripts.org/Images/paint.png");
				siggy = getImage("", false,
						"http://www.universalscripts.org/UFletch_generate.php?user="
								+ name);
				pic = getImage("camera.png", true,
						"http://www.universalscripts.org/Images/camera.png");
			}
	...
	private void createSignature() {
		if (!connection) {
			try {
				...
				url = new URL(
						"http://www.universalscripts.org/UFletch_submit.php");
	...
	public class gui extends JFrame {
		...
		private String getMessage() {
			...
			if (connection) {
				try {
					url = new URL(
							"http://www.universalscripts.org/Images/message.txt")
							.openConnection();
		...
		private void button2ActionPerformed(ActionEvent e) {
			try {
				Desktop.getDesktop()
						.browse(new URL(
								"http://www.universalscripts.org/highscores.php")
								.toURI());
			} catch (MalformedURLException e1) {
			} catch (IOException e1) {
			} catch (URISyntaxException e1) {
