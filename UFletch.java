...
public class UFletch extends Script implements PaintListener, MouseListener,
	...
	private void getExtraImages() {
		...
		try {
			...
			if (code == 200) {
				icon = getImage("icon.png", true,
						"http://www.universalscripts.org/ufletch/Images/icon.png");
	...
	private void loadSettings() {
		...
		File f = new File(getCacheDirectory() + File.separator + "UFletch.ini");
		try {
	...
	private class MousePathPoint extends Point {
		...
		public Color getColor() {
			return new Color(
					getPaintColors(gui.comboBox10).getRed(),
					getPaintColors(gui.comboBox10).getGreen(),
					getPaintColors(gui.comboBox10).getBlue(),
	...
	private class MousePathPoint2 extends Point {
		...
		public Color getColor2() {
			return new Color(
					getPaintColors(gui.comboBox14).getRed(),
					getPaintColors(gui.comboBox14).getGreen(),
					getPaintColors(gui.comboBox14).getBlue(),
					toColor(256 * ((finishTime - System.currentTimeMillis()) / lastingTime)));
		}
	}
